...
def extract_and_save_features(
    ...
    from calibpy.utils.feature_extractor import FeatureExtractor, ImageProcessor
    ...
    for i in range(len(img_files)):
        ...
        def filter_outliers(points, tol=0.5, radius_multiplier=0.85):
            ...
            Args:
                ...
                radius_multiplier:  A factor to shrink the radius for edge detection.
                Returns:
            ...
            return neighbor_mask & edge_mask
